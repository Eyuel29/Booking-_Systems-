...
const Navbar = () => {
  ...
  max-md:text-lg z-50 flex max-md:flex-col md:flex-row items-center
  max-md:justify-center gap-9 min-md:px-9 py-4 max-md:h-screen
  rounded-none md:rounded-full backdrop-blur bg-black/70 md:bg-white/10 md:border
  border-gray-300/50 overflow-hidden transition-[width] duration-500
...
>
        ...
        />
                ...
                <Link onClick={()=> {scrollTo(0,0); setIsOpen(false) }} to ='/packages'>Packages</Link>
